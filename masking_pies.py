...
class MASK_setup_masking_scene(bpy.types.Operator):
...
class MASK_newmasklayer(bpy.types.Operator):
...
class MASK_set_to_add(bpy.types.Operator):
    """docstring for MASK_newmasklayer"""
...
class MASK_lock_inactive_layers(bpy.types.Operator):
    """docstring for MASK_newmasklayer"""
...
class MASK_set_drawtype(bpy.types.Operator):
    """docstring for MASK_newmasklayer"""
...
class MASK_set_marker_drawtype(bpy.types.Operator):
    """docstring for MASK_newmasklayer"""
...
class MASK_set_to_subtract(bpy.types.Operator):
    """docstring for MASK_newmasklayer"""
...
class MASK_clear_keyframes(bpy.types.Operator):
    """docstring for MASK_newmasklayer"""
