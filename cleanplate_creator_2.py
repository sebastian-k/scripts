...
"version": (1, 0),
"blender": (2, 7, 2),
"location": "3D View > Cleanplate Creator",
"description": "Generate a Cleanplate Object",
"warning": "",
"wiki_url": "",
"tracker_url": "",
"category": "3D View"}
...
def register():
    ...
    bpy.utils.register_class(VIEW3D_OT_texture_extraction_setup)
    bpy.utils.register_class(VIEW3D_OT_cleanplate_painter_setup)
    bpy.utils.register_class(VIEW3D_OT_clean_render_switcher)
    bpy.utils.register_class(VIEW3D_PT_cleanplate_creator)
...
def unregister():
    ...
    bpy.utils.unregister_class(VIEW3D_OT_texture_extraction_setup)
    bpy.utils.unregister_class(VIEW3D_OT_cleanplate_painter_setup)
    bpy.utils.unregister_class(VIEW3D_OT_clean_render_switcher)
    bpy.utils.unregister_class(VIEW3D_PT_cleanplate_creator)
